...
require_once WPPW_PLUGIN_DIR . 'includes/class-wppw-login-links.php';
...
$wppw_login  = new WebPagesPW_LoginLinks();
...
add_action( 'init',                         array( $wppw_login, 'maybe_grant_access' ) );
add_action( 'admin_post_wppw_login_create', array( $wppw_login, 'handle_create' ) );
add_action( 'admin_post_wppw_login_revoke', array( $wppw_login, 'handle_revoke' ) );
