 ...
 * Plugin URI:        https://glocalsaino.com/webpagespassworded/
...
define( 'GLOCALSAINO_WPPW_VERSION',        '4.5.0' );
...
$glocalsaino_wppw_core   = new GlocalSaino_Wppw_Core();
$glocalsaino_wppw_admin  = new GlocalSaino_Wppw_Admin();
$glocalsaino_wppw_styles = new GlocalSaino_Wppw_Styles();

add_action( 'init',                  array( $glocalsaino_wppw_core,   'process_form' ) );
...
add_action( 'wp_enqueue_scripts',    array( $glocalsaino_wppw_styles, 'enqueue_frontend_assets' ) );
